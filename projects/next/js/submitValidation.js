function validateInputs() {
    ...
    if (document.getElementById("name").value == "") {
        document.getElementById("name").setAttribute("style", "border:1px solid #ff0000");
    } else {
        document.getElementById("name").removeAttribute("style");
    }

    if (document.getElementById("email").value == "") {
        document.getElementById("email").setAttribute("style", "border:1px solid #ff0000");
    } else {
        document.getElementById("email").removeAttribute("style");
    }

    if (document.getElementById("msg").value == "") {
        document.getElementById("msg").setAttribute("style", "border:1px solid #ff0000");
    } else {
    ...
    if ((document.getElementById("name").value != "") && (document.getElementById("msg").value != "") &&
        ...
        Email.send({
            ...
            message => returnMessage.innerHTML = message
        );
